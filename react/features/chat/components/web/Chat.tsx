...
const Chat = ({
    ...
    */
    ...
    function renderChat() {
        return (
            <>
                 {webinarEnabled && !isModerator?  (_isPollsEnabled&&renderTabforChatOnly()):(_isPollsEnabled && renderTabs())}
    ...
    function renderTabs() {
        return (
            <Tabs
                accessibilityLabel =  { t(  !isModerator && webinarEnabled?'chat.title': (_isPollsEnabled? 'chat.titleWithPolls' : 'chat.title')) }
    ...
    function renderTabforChatOnly() {
        return (
            <Tabs
                accessibilityLabel = { t(_isPollsEnabled &&!webinarEnabled ? 'chat.title' : 'chat.title') }
                onChange = { onChangeTab }
                selected = { _isPollsTabFocused ? CHAT_TABS.POLLS : CHAT_TABS.CHAT }
                tabs = { [ {
                    accessibilityLabel: t('chat.tabs.chat'),
